  ...
  return (
    <section className="bg-slate-900  mt-8 mb-8 pl-5 pr-8 pb-10 pt-10">
      <div>
       ...
       <p className="pt-3 pb-2 text-white ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, <br /> pulvinar dapibus leo.</p>
       <button className=" px-4 py-3 rounded-md w-2/12 mr-8 bg-red-500 text-white  mt-4 ">View All class </button>
       </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6">
      {
        classes.slice(0,6).map(singleClass => <ClassCard
        key={singleClass._id}
